const consejos = [
  {
    ...
    subtitulo:
      "Cómo estructurar raciones y evitar errores comunes en el primer año",
    ...
    datosExtra:
      "Evitar cambios bruscos de dieta. No dar leche ni huesos cocidos.",
    imagen:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnmP8ffKx1B2CRXQ0tgfwSzn-TJLYqF9vpcA&s",
  },
  {
    id: 2,
    categoria: "Higiene",
  ...
  },
  {
    ...
    descripcionLarga:
      "Un cepillado constante mejora la salud de la piel, reduce la caída y permite detectar parásitos o lesiones tempranas. Perros de pelo corto: guante de goma 2–3 veces por semana para retirar pelo muerto. Pelo medio: cepillo de púas suaves y peinado en capas, mínimo 3 veces/semana. Pelo largo: cepillo dematting y acondicionador en spray, a diario si hay tendencia a nudos. Revisa zonas conflictivas (detrás de orejas, axilas, ingles). Termina con paño húmedo para retirar polvo y aplica un acondicionador sin aclarado si el pelaje está muy seco.",
    datosExtra:
      "Evitar cepillos metálicos sin protección. Supervisar en cachorros.",
      imagen:
      "https://www.tiendanimal.es/articulos/wp-content/uploads/2016/03/como-cepillar-a-un-perro-y-con-que-frecuencia-hacerlo.jpg",
  },
  {
    id: 6,
    categoria: "Accesorios",
  ...
  },
  {
    ...
    datosExtra:
      "Lavar bien las frutas. Evitar frutas con hueso o semillas grandes.",
      imagen:
      "https://purina.cl/sites/default/files/2024-03/verduras-pueden-comer-perros-zanahoria-cl.jpg",
  },
  {
    id: 11,
    categoria: "Higiene",
  ...
  },
  {
    ...
    datosExtra:
      "Colocar una manta con su olor. Usar feromonas si hay ansiedad.",
      imagen:
      "https://images.squarespace-cdn.com/content/v1/5a8abbee6f4ca301c2d1b962/1749673398833-KJ1T6UPPG44BAP20B9L7/perro+transportin+seguridad+coche+Pipper.jpg",
  },
  {
    id: 13,
    categoria: "Comida",
    ...
    descripcionLarga:
      "Los gatos son carnívoros estrictos, por lo que su pienso debe tener como primer ingrediente una fuente de proteína animal de alta calidad. Evita piensos con exceso de cereales, subproductos o aditivos artificiales. Busca fórmulas que incluyan taurina, ácidos grasos omega-3 y un equilibrio adecuado de minerales para prevenir problemas urinarios. Para cambiar de pienso, realiza una transición gradual durante 7–10 días, mezclando el nuevo alimento con el anterior en proporciones crecientes. Esto evita trastornos digestivos y mejora la aceptación. Controla el peso y la condición corporal del gato, y ajusta la ración según su nivel de actividad y edad.",
    datosExtra:
      "Evitar piensos con maíz como primer ingrediente. Consultar al veterinario si hay intolerancias.",
      imagen:
      "https://farmahigiene.es/modules/dbblog/views/img/post/blog%20cual%20es%20el%20mejor%20pienso%20para%20gatos.png",
  },
  {
    id: 14,
    categoria: "Higiene",
  ...
  },
  {
    ...
    imagen:
      "https://www.rover.com/blog/wp-content/uploads/2018/03/540747396_344cde9fda_o.jpg",
  },
  {
    id: 17,
    categoria: "Higiene",
    ...
    datosExtra:
      "Evitar baños semanales salvo indicación veterinaria. Secar bien las orejas y pliegues.",
      imagen:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgBOzr_T1XTB8cAEN4y_9f7LVSiqoNyIi-sw&s",
  },
  {
    id: 18,
    categoria: "Accesorios",
  ...
  },
  {
    ...
    descripcionLarga:
      "El sobrepeso en mascotas puede derivar en enfermedades como diabetes, problemas articulares y cardiovasculares. Para mantener un peso saludable, es fundamental medir las raciones con báscula, evitar dar sobras de comida humana y fomentar el ejercicio diario. Observa la silueta del animal: deben notarse las costillas al tacto sin exceso de grasa. Si notas aumento de peso, reduce la ración un 10% y consulta al veterinario para un plan nutricional. Existen piensos light o específicos para control de peso que pueden ayudar en el proceso.",
    datosExtra:
      "Evitar premios calóricos. Usar juguetes interactivos para fomentar el movimiento.",
      imagen:
      "https://www.zooplus.es/magazine/wp-content/uploads/2021/03/2023_02_Obesity_Infography_C_1080x1920_ES.webp",
  },
  {
    id: 23,
    categoria: "Higiene",
    ...
    datosExtra:
      "Nunca usar pasta humana. Introducir el cepillado desde cachorro.",
      imagen:
      "https://www.purina.es/sites/default/files/2020-12/How%20to%20Look%20After%20Your%20Dog%27s%20TeethTEASER.jpg",
  },
  {
    id: 24,
    categoria: "Accesorios",
    ...
    datosExtra:
      "Evitar cambios bruscos de entorno. Supervisar los primeros días para prevenir escapes.",
      imagen:
      "https://m.media-amazon.com/images/I/81blQ94diOL._AC_UF1000,1000_QL80_.jpg",
  },
];
